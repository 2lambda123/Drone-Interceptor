...
#    count=0 #development use to limit number of loops to 1000
...
#         # Draw bounding box
#        if ok:# Tracking success, ok==1 response from tracker.update
#            p1 = (int(bbox[0]), int(bbox[1]))
#            p2 = (int(bbox[0] + bbox[2]), int(bbox[1] + bbox[3]))
#            cv2.rectangle(frame, p1, p2, (255,0,0), 2, 1)#cv2.rectangle(img,topleftcorner-x1y1, bottomrightcorner-x2y2, (color RGB 8bit), thickness, linetype, shift)
