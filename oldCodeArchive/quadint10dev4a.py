...
When in all modes:
  Knob sets track & target area box size.
Threshold value is constant, or maybe use throttle stick to set.
"""
#
...
def measure_temp():
        ...
        Processing Logic:
            - Executes a system command to retrieve the temperature.
            - Removes the "temp=" prefix from the returned string.
            - Returns the temperature as a float value.
        Example:
            >>> measure_temp()
            50.5""""
...
def main():
    ...
    global SelctPtValR
    global clickflag
    centerXcol=framewidth/2
    centerYrow=frameheight/2
    xError1=0
    yError1=0
    xError2=0
    yError2=0
...
#                        print(time.time()-start,' LOOP TIME')
                        ...
                        if (achannel[8]>1200):#B switch On with F OFF
                            ...
                            if amode>10:
                                ...
                                xError1=tpoint[0]-centerXcol#positive quadrant error, cmd +pitch or +yaw to remove +error
                                yError1=tpoint[1]-centerXcol
...
#                                xError2=xError1
#                                yError2=yError1
                                #=(Kp*xError1)+(Ki*xIntegral)#+(Kd*xDer)
                                #=(Kp*yError1)+(Ki*yIntegral)#+(Kd*yDer)
